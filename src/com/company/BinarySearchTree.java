...
public class BinarySearchTree implements SortedADT {
    ...
    private SortedLinkedList treeAsList;
    ...
    public String getInOrder(){
        ...
        if(this.root != null){
            inOrder += this.getInOrder(this.root);
        }
        return  inOrder;
    }
    ...
    public void displayPetInOrder(){
        if(this.root!= null){
            this.displayPetInOrder(this.root);
        }else{
            System.out.println("Tree is empty!");
        }
    }
    private void displayPetInOrder(BinarySearchTreeNode current){
        if(current!= null){
            this.displayPetInOrder(current.left);
            System.out.print(((Pet)current.object).getPetType());
            if (((Pet)current.object).getProducts().isEmpty()){
                System.out.println(": No products available at the moment!!");
            }else{
                System.out.println(": Products available!");
            }

            this.displayPetInOrder(current.right);
        }
    }
